process vafAugment {
    ...
    script:
    vcf_gz_out = "${meta.sample_id}_vs_${meta.match_normal_id}.flagged.vafaugment.vcf.gz"
    vcf_tbi_out = "${meta.sample_id}_vs_${meta.match_normal_id}.flagged.vafaugment.vcf.gz.tbi"
    """
