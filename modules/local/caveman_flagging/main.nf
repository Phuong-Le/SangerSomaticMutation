process cavemanFlagging {
    ...
    script:
    vcf_out = "${meta.sample_id}_vs_${meta.match_normal_id}.flagged.muts.ids.vcf"
    vcf_gz_out = "${meta.sample_id}_vs_${meta.match_normal_id}.flagged.muts.ids.vcf.gz"
    vcf_tbi_out = "${meta.sample_id}_vs_${meta.match_normal_id}.flagged.muts.ids.vcf.gz.tbi"
    """
